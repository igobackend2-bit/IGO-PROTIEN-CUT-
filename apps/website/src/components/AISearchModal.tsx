...
export const AISearchModal: React.FC<AISearchModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/70 backdrop-blur-md flex items-center justify-center p-4">
      <div className="bg-white border border-neutral-200 rounded-3xl max-w-2xl w-full text-[#0A1F12] p-6 relative shadow-2xl overflow-hidden">
        {/* Background glow */}
        ...
        <form onSubmit={handleSearch} className="flex gap-2 mb-4">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full bg-white border border-neutral-200 focus:border-emerald-500 rounded-2xl pl-11 pr-4 py-3 text-xs text-[#0A1F12] focus:outline-none"
            />
          </div>
          <button
            type="submit"
        ...
        <div className="flex flex-wrap gap-1.5 mb-6">
          ...
          {samplePrompts.map((p) => (
            <button
              ...
              className="text-[11px] bg-neutral-50 border border-neutral-200 hover:border-emerald-400 px-2.5 py-1 rounded-full text-neutral-600 hover:text-[#0A1F12] transition cursor-pointer"
            >
              "{p}"
            </button>
          ))}
