...
import { Snowflake, Fish, Flame, X, ArrowRight } from 'lucide-react';
...
export const GuidesSection: React.FC = () => {
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
      <div>
        <div className="text-xs font-bold text-emerald-600 uppercase tracking-widest">Kitchen Guides</div>
        <h2 className="text-2xl sm:text-3xl font-black text-[#08120B] tracking-tight">Cook It Right</h2>
      </div>
          ...
          return (
            ...
            >
              ...
              <div className="p-4 space-y-2">
                <h3 className="text-sm font-black text-[#08120B] leading-snug line-clamp-2">{guide.title}</h3>
          ...
          >
            <div className="relative aspect-16/9 bg-neutral-100">
              ...
              <button
                ...
                className="absolute top-3 right-3 w-8 h-8 rounded-full bg-white/90 hover:bg-white flex items-center justify-center text-[#08120B] cursor-pointer transition"
            ...
            <div className="p-6 sm:p-7 space-y-4">
              <h3 className="text-xl font-black text-[#08120B] leading-tight">{openGuide.title}</h3>
