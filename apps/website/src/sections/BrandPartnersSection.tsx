  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
      <div className="text-center max-w-xl mx-auto space-y-2">
        <span className="text-xs font-bold text-emerald-600 uppercase tracking-widest">Trusted Sourcing Network</span>
        <h2 className="text-2xl sm:text-3xl font-black text-[#08120B] tracking-tight">Our Farm & Supply Partners</h2>
        <p className="text-xs text-neutral-600">Sourced directly from certified farms and hatcheries across the region.</p>
      </div>
