...
class SubscriptionEmptyState extends StatelessWidget {
  ...
  const SubscriptionEmptyState({super.key, required this.title, required this.message});
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: const Icon(Icons.autorenew_rounded, size: 48, color: AppColors.primary),
            ),
...
class SubscriptionErrorState extends StatelessWidget {
  ...
  const SubscriptionErrorState({super.key, required this.onRetry});
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            Text("Couldn't load subscriptions", style: GoogleFonts.outfit(fontSize: 15, fontWeight: FontWeight.w700, color: AppColors.textPrimary)),
            const SizedBox(height: 6),
  ...
  Widget build(BuildContext context) {
    return Shimmer.fromColors(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) => Container(height: 110, decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(16))),
      ),
    );
  }
}
