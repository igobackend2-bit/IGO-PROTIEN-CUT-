...
class PromotionEmptyState extends StatelessWidget {
  const PromotionEmptyState({super.key});
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('No live offers right now', style: GoogleFonts.outfit(fontSize: 15, fontWeight: FontWeight.w700, color: AppColors.textPrimary)),
            const SizedBox(height: 6),
            Text('Check back soon — new deals drop regularly.', textAlign: TextAlign.center, style: GoogleFonts.outfit(fontSize: 12.5, color: AppColors.textSecondary, height: 1.4)),
          ],
        ),
      ),
    );
...
class PromotionErrorState extends StatelessWidget {
  final VoidCallback onRetry;
  const PromotionErrorState({super.key, required this.onRetry});
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            Text("Couldn't load offers", style: GoogleFonts.outfit(fontSize: 15, fontWeight: FontWeight.w700, color: AppColors.textPrimary)),
            const SizedBox(height: 6),
        ...
        children: [
          ...
          ...List.generate(
            ...
            (i) => Padding(
              ...
              child: Container(height: 88, decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(16))),
            ),
          ),
        ],
      ),
