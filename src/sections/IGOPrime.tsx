...
const benefits = [
  {
    ...
    desc: 'Unlimited free delivery on all orders above ₹199.'
  },
  {
    icon: Zap,
    title: 'Priority Slots',
    desc: 'Get your protein in under 30 mins with dedicated Prime riders.'
  },
  {
    icon: ShieldCheck,
    title: 'Prime Only Cuts',
    desc: 'Exclusive access to Heritage Farm batches and dry-aged steaks.'
  },
  {
    icon: Star,
    title: 'Cashback Rewards',
    desc: 'Flat 5% cashback on every purchase, credited instantly.'
  }
];
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <p className="mt-8 text-neutral-400 text-lg leading-relaxed max-w-lg">
              ...
              exclusive cuts, and zero fees. It's more than a membership—it's 
              a commitment to quality.
            </p>

            <div className="mt-12 flex flex-col sm:flex-row gap-6">
              <button className="px-10 py-5 bg-igo-gold text-neutral-dark font-bold rounded-2xl hover:scale-105 transition-all shadow-2xl shadow-igo-gold/20 flex items-center justify-center gap-3 group">
                Join Now at ₹499/year
                <ChevronRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </button>
              <button className="px-10 py-5 bg-white/5 border border-white/10 text-white font-bold rounded-2xl hover:bg-white/10 transition-all backdrop-blur-md">
                View All Benefits
              </button>
            </div>
            ...
            {benefits.map((benefit, index) => {
              ...
              return (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="glass-dark p-8 rounded-[2.5rem] group hover:border-igo-gold/30 transition-all duration-500"
                >
