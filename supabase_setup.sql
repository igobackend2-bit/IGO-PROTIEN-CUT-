...
ALTER TABLE public.profiles ADD COLUMN IF NOT EXISTS is_prime_member BOOLEAN DEFAULT FALSE;
ALTER TABLE public.profiles ADD COLUMN IF NOT EXISTS prime_since TIMESTAMPTZ;
